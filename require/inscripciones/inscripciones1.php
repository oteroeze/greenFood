          ...
          <div class="form-col">
            ...
            <div class="form-group" style="display: none;">
                <div class="custom-control custom-checkbox mb-3">
                    <input type="checkbox" class="custom-control-input" id="customControlValidation1" value="Pulled" name="curso" checked>
                    <label class="custom-control-label" for="customControlValidation1">Pulled</label>
                </div>
            </div>
        </div>
            <!--<script>
