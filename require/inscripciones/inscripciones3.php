<section id="book-a-table" class="book-a-table">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Agradecemos tus ganas y entusiasmo por participar con nosotros. 
          <strong style="font-weight:bold;">Si vas a confirmar la solicitud del cupo para el curso, rellena este formulario. 
          De lo contrario, por cualquier consulta por favor <a href="index.php#contact">Contactate</a> 
          ...
          <div class="form-col">
            ...
            <div class="form-group" style="display: none;">
                <div class="custom-control custom-checkbox mb-3">
                    <input type="checkbox" class="custom-control-input" id="customControlValidation1" value="Navideño" name="curso" checked>
                    <label class="custom-control-label" for="customControlValidation1">Navideño</label>
                </div>
            </div>
        </div>
            <!--<script>
